...
def main(n_graphs, n_nodes_ini, n_nodes_fin, step, prob):
    ...
    l_t = gr.time_kruskal(
        n_graphs, n_nodes_ini, n_nodes_fin, step, prob, fl_cc=False)
    print("kruskal sin CC\n", l_t)

    print("\najuste de tiempos kruskal con CC....................")
    l_t_cc = gr.time_kruskal_2(
        n_graphs, n_nodes_ini, n_nodes_fin, step, prob, fl_cc=True)
    print("kruskal con CC\n", l_t_cc)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="comprobador de la práctica 2")
    ...
    main(args.num_graphs, args.initial_size, args.final_size, args.step,
         args.prob)
